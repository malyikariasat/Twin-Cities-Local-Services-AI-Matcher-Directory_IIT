      ...
      <div className="details-card">
        ...
        <div className="info-box">
          ...
          <div>
            <h4>Distance</h4>
            <p>
              {getEstimatedDistance(provider.area)} away
            </p>
          </div>
        </div>
        ...
        <div className="ai-box">
          ...
          <p>
            This provider has one of the highest
            ratings, is verified, responds quickly
            and matches your requested location
            and budget. AI selected this provider
            because it offers the best overall value.
          </p>
        </div>
